...
/// An immutable structured `do`/`while` statement produced by [DoWhileLoop#builder()].
///
...
public final class DoWhileLoop
        implements Statement
{
    ...
    private DoWhileLoop(Object target, BytecodeExpression condition, CodeBlock body, String description)
    {
